...
def api_save_sheet():
    ...
    google_info.save_sheet_id(user_id, info)
    print(info)
...
def api_google():
    ...
    print(google_info.new_google_user(code, auth_url))
